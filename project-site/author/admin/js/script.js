$(document).ready(function () {
    $(document).on("change", "#student_img", function (e) {
        var image_name = e.target.files[0].name;
        $("#student_img_label").html(image_name);
    });

    $(document).on("change", "#student_id_img", function (e) {
        var image_name = e.target.files[0].name;
        $("#student_id_img_label").html(image_name);
    });

    $(document).on("change", "#student_cv", function (e) {
        var image_name = e.target.files[0].name;
        $("#student_cv_label").html(image_name);
    });
