                    ...
                    <div class="card dashboard text-white bg-success o-hidden h-100">
                        <div class="card-body">
                            ...
                            <div class="mr-5">
                                ...
                                $sql = "SELECT COUNT(academy_id) AS total_booking FROM booking WHERE academy_id = '" . get_escape_sql($user_id) . "'";
                ...
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card dashboard text-white bg-success o-hidden h-100">
                        <div class="card-body">
                            ...
                            <div class="mr-5">
                                <?php
                                $sql = "SELECT COUNT(id) total_student FROM users_student WHERE university_name = '" . get_escape_sql($_SESSION['uv_id']) . "'";
                                $result = get_query($sql);
                                if (get_row_count($result) > 0) {
                                    $row = get_fetch_array($result);
                                    $student_number = $row['total_student'];
                                    echo "<h5>{$student_number} Student!</h5>";
                                } else {
                                    echo "<h5>0 Student</h5>";
                                }
                                ?>
                            </div>
                        </div>
